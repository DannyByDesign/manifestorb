...
import type { ParsedMessage, Attachment } from "@/server/lib/types";
...
import { createAndSaveFilingFolder } from "@/features/drive/folder-utils";
import {
  extractTextFromDocument,
  isExtractableMimeType,
} from "@/features/drive/document-extraction";
import { analyzeDocument } from "@/features/document-filing/ai/analyze-document";
import {
...
function resolveFolderTarget(
  ...
  return {
    driveConnection: connection,
    folderId: "root",
    folderPath: analysis.folderPath || "Amodel Filed",
    needsToCreateFolder: true,
  };
}
