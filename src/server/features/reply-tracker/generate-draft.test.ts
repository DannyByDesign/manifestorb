...
vi.mock("@/features/reply-tracker/ai/draft-reply", () => ({
  aiDraftReply: vi.fn(),
}));

vi.mock("@/server/lib/redis/reply", () => ({
...
vi.mock("@/features/reply-tracker/ai/reply-context-collector", () => ({
  aiCollectReplyContext: vi.fn().mockResolvedValue(null),
}));

vi.mock("@/features/calendar/ai/availability", () => ({
