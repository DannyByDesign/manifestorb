...
import type { UserPersona } from "@/features/reports/ai/build-user-persona";
...
Keep each action short (single sentence, no wrap-up lines). Return JSON only (no markdown or extra keys).`;
