...
export const inboxSnoozeOrDeferSkill = createBaselineSkill({
  ...
  requiredSlots: ["defer_until"],
  optionalSlots: ["reason"],
  allowedTools: ["email.snoozeThread"],
  plan: [
    { id: "snooze", description: "Apply snooze/defer to target threads", capability: "email.snoozeThread", requiredSlots: ["defer_until"] },
  ],
  ...
  templates: {
    ...
    blocked: "I need a defer-until time.",
