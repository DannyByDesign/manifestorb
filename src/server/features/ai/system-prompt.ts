...
- Use fromConcept/toConcept/ccConcept in email.search and ask a follow-up question to define X in concrete terms (sender emails, sender domains, labels/categories, and a time window).
