...
import type { MessageWithPayload, ParsedMessage } from "@/server/lib/types";
...
export class GmailProvider implements EmailProvider {
  ...
  async blockUnsubscribedEmail(messageId: string): Promise<void> {
    ...
    if (!unsubscribeLabel?.id) {
      ...
      // Still proceed to remove from inbox even without the label
    }
  ...
  async moveThreadToFolder(
    ...
    throw new Error("unsupported_operation:move_thread_to_folder");
  }
