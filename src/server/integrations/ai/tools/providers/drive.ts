...
import { createDriveProviderWithRefresh } from "@/server/utils/drive/provider";
import { type DriveProvider } from "@/server/utils/drive/types";

// Re-export the type so consumers just import this file
export type { DriveProvider } from "@/server/utils/drive/types";
